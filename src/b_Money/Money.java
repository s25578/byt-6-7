...
public class Money implements Comparable {
	...
	public String toString() {
        ...
        double formattedAmount = amount / 100.0;
        return decimalFormat.format(formattedAmount) + " " + currency.getName();
    }
	...
	public Boolean equals(Money other) {
		return this.currency.equals(other.getCurrency()) && this.amount == other.getAmount();
	}
	...
	public Money add(Money other) {
		if (!this.currency.equals(other.getCurrency())) {
            int convertedAmount = (int) Math.round(other.getAmount() * other.getCurrency().getRate() / currency.getRate());
	...
	public int compareTo(Object other) {
        ...
        int otherValue = ((Money)other).universalValue();
